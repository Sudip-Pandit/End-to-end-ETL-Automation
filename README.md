...
# Explanation
I have created a database name t_demo in mysql table then I use this database. Next step is I create a table name t_autoSqoopHive in hive then, load the data reside in HDFS directory /user/cloudera/txnsd.txt into table t_autoSqoopHive Data is in mysql table. 
